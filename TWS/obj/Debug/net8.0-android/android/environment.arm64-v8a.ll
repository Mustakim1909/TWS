...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 497478949290381492, ; hash 0x6e76677f7b010b4, from name: QuestPdfSkia
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libQuestPdfSkia.so
	...
	%struct.DSOCacheEntry {
		i64 1017042461027703713, ; hash 0xe1d42bad30b9ba1, from name: QuestPdfSkia.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libQuestPdfSkia.so
		ptr null; void* handle (0x0)
	}, ; 2
	...
	%struct.DSOCacheEntry {
		i64 8072034684033217297, ; hash 0x7005a0c7146eb311, from name: libqpdf.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 9498779937522542391, ; hash 0x83d27206c7a36737, from name: libQuestPdfSkia.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libQuestPdfSkia.so
		ptr null; void* handle (0x0)
	}, ; 28
	...
	%struct.DSOCacheEntry {
		i64 11968241762721315903, ; hash 0xa617bc7904ffbc3f, from name: qpdf.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libqpdf.so
		ptr null; void* handle (0x0)
	}, ; 34
	%struct.DSOCacheEntry {
		i64 12370829031384308746, ; hash 0xabae0375e8c05c0a, from name: libQuestPdfSkia
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libQuestPdfSkia.so
		ptr null; void* handle (0x0)
	}, ; 35
	...
	%struct.DSOCacheEntry {
		i64 17925975785558469992, ; hash 0xf8c5dc0046776d68, from name: libqpdf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libqpdf.so
		ptr null; void* handle (0x0)
	}, ; 46
	...
	%struct.DSOCacheEntry {
		i64 18118987855136895418, ; hash 0xfb739374ab0d31ba, from name: qpdf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libqpdf.so
		ptr null; void* handle (0x0)
	}, ; 49
...
@.env.7 = private unnamed_addr constant [37 x i8] c"3e686c79-c27a-4919-b405-c4f12c2cade6\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [20 x i8] c"com.companyname.tws\00", align 1
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [19 x i8] c"libQuestPdfSkia.so\00", align 1
